"""
svd.py  -  Task 9: SVD (Matrix Factorization) Baseline
Runs truncated SVD on score_A and score_B matrices, comparing n_factors=50/100/200.
Recommendation is done via batched GEMM in the main process; numpy MKL handles
multi-threading automatically -- no Pool needed.
"""
